...
class CRDT {
	...
	localInsert(val, siteId, type, from, to) {
		...
		*/
		...
		//console.log(from)
		var char = new Char(val[0], this.siteId, from, null)
	...
	remoteInsert(char) {
		const pos = this.findRemoteInsertPos(char)
	}
